  ...
  files.".config/stylix/ytm.css".text =
    ...
    + ''
      ...
      *
      ...
      div.text.ytmusic-menu-navigation-item-renderer
      {
        color: var(--ctp-text) !important;
      }
      ...
      .lyrics-picker-dot[style*="background: white"]
      {
        background: var(--ctp-text) !important;
      }

      .lyrics-picker-dot[style*="background: black"]
      {
      ...
      {
        content: url("https://raw.githubusercontent.com/catppuccin/youtubemusic/main/assets/icons/mocha.png") !important;
      }
      ...
      {
        content: url("https://raw.githubusercontent.com/catppuccin/youtubemusic/main/assets/icons/mocha-playlist.png") !important;
      }
      ...
      {
        content: url("https://raw.githubusercontent.com/catppuccin/youtubemusic/main/assets/icons/mochaprem1.png") !important;
        background-color: var(--ctp-accent) !important;
      }
      ...
      {
        content: url("https://raw.githubusercontent.com/catppuccin/youtubemusic/main/assets/icons/mochaprem2.png") !important;
        background-color: var(--ctp-accent) !important;
      }
      ...
      {
        content: url("https://raw.githubusercontent.com/catppuccin/youtubemusic/main/assets/icons/mochaprem3.png") !important;
        background-color: var(--ctp-accent) !important;
      }

      img#img.style-scope.yt-img-shadow[src="https://www.gstatic.com/youtube/img/promos/growth/ytm_lp2_logo_desktop_552x71.png"]
      {
        content: url("https://raw.githubusercontent.com/catppuccin/youtubemusic/main/assets/icons/mochapremtitle.png") !important;
        background-color: var(--ctp-accent) !important;
      }
      ...
      .yt-icon{
        fill: var(--ctp-accent) !important;
        --icon-color: var(--cpt-accent) !important;
      }
      ...
      ytmusic-player-bar.repeat.ytmusic-player-bar
      {
        color: var(--ctp-text) !important;
      }
      ...
      {
        content: url("https://raw.githubusercontent.com/catppuccin/youtubemusic/main/assets/icons/mochaplaylistempty.png") !important;
      }
